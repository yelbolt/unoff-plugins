...
2. They pick a scope (selection, page, document) and the categories to audit: color, spacing, radius, typography (including font family, text case and text decoration), dimension, opacity, rotation.
