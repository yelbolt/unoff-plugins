![GitHub package.json version](https://img.shields.io/github/package-json/v/a-ng-d/token-lint?color=informational) ![GitHub last commit](https://img.shields.io/github/last-commit/a-ng-d/token-lint?color=informational) ![GitHub](https://img.shields.io/github/license/a-ng-d/token-lint?color=informational)
