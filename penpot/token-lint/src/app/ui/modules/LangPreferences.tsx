...
> {
  ...
  render() {
    ...
    return (
      <Feature
        isActive={this.features.USER_LANGUAGE.isActive()}
      >
        <Section
          title={
            <SimpleItem
                    ...
                    options={[
                      {
                        ...
                        isBlocked: this.features.USER_LANGUAGE_EN_US.isBlocked(),
                      ...
                      },
                      {
                        ...
                        isBlocked: this.features.USER_LANGUAGE_FR_FR.isBlocked(),
